...
impl AccountManager {
    ...
    pub async fn create_account(
        ...
        // Generate DID
        let did = self.generate_did(&handle);
    ...
    fn generate_did(&self, handle: &str) -> String {
        // Use did:web for now (did:plc integration in Phase 6)
        format!("did:web:{}.{}", handle, self.config.service.hostname)
    }
